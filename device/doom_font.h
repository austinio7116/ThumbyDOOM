 ...
 * ultimately derived from Pemsa (MIT license — see doom_font.c
 ...
 */
#ifndef THUMBYDOOM_FONT_H
#define THUMBYDOOM_FONT_H

#include <stdint.h>

#define DOOM_FONT_CELL_W   4
#define DOOM_FONT_CELL_H   6
#define DOOM_FONT_CELL_W2  8
#define DOOM_FONT_CELL_H2  12
